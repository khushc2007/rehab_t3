...
export interface HandState{connected:boolean;simMode:boolean;sim:SimState;fingers:number[];emg:number;battery:number;targetReps:number;exerciseName:string;
...
fingers:[0,0,0,0,0],emg:0,battery:100,targetReps:10,exerciseName:'Finger Flexion',...fresh(),
